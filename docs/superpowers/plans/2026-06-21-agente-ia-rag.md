    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription className="text-xs">
          Sube documentos (PDF, .txt, .md) o pega texto. El agente responderá con esta información. Máx 20 documentos, 2 MB c/u.
        </CardDescription>
      </CardHeader>
...
> Verifica que `@/components/ui/textarea` existe (usado en otras secciones). Si no, usa el patrón de Textarea del proyecto o un `<textarea>` con clases de `_form.tsx`.
