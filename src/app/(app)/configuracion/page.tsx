...
import { ChevronRightIcon, KeyIcon, UsersIcon, MessageSquareIcon } from "lucide-react";
        ...
        <CardContent className="p-0">
          <ul className="divide-y border-t">
            ...
            <ConfigLink
              ...
              desc="Crea atajos para respuestas frecuentes"
            />
            <ConfigLink
              href="/configuracion/equipo"
              icon={<UsersIcon className="size-4 text-emerald-600" />}
              title="Equipo"
              desc="Invita a tu equipo a la organización y gestiona miembros"
            />
          </ul>
        </CardContent>
      </Card>
